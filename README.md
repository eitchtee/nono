...
- **Timer** under the board. It starts when the board appears and stops while the page is hidden or out of focus, covering the board so a pause never buys thinking time. Wins share their time.
